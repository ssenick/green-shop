...
import lgMediumZoom from 'lightgallery/plugins/zoom/lg-zoom.min.js';
...
const galleriesZoom = document.querySelectorAll('[data-medium-zoom]');
if (galleriesZoom.length) {
  let galleyItems = [];
  galleriesZoom.forEach((gallery) => {
    galleyItems.push({
      gallery,
      galleryClass: lightGallery(gallery, {
        selector: '[data-tagret-zoom]',
        licenseKey: '7EC452A9-0CFD441C-BD984C7C-17C8456E',
